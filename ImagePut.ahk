...
class ImagePut {
   ...
   class BitmapBuffer {
      ...
      ImageSearch(image, variation := 0) {
         ...
         ; C source code - https://godbolt.org/z/CHANGE_THIS_PART
         code := this.Base64Code((A_PtrSize == 4)
            ...
            : "")
      ...
      ImageSearchAll(image, variation := 0) {
         ...
         code := this.Base64Code((A_PtrSize == 4)
            ...
            : "")
