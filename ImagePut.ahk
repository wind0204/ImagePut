   ...
   class BitmapBuffer {
      ...
      ImageSearch(image, variation := 0) {
         ...
         code := this.Base64Code((A_PtrSize == 4)
            ...
            : "QVdBVkFVQVRVV1ZTSIPsOEQPt5wkwAAAAIuEJLgAAABIiYwkgAAAAESJxouMJKgAAABIiZQkiAAAAIXAD4VaAwAAi4QksAAAAInP"
            . "icqLrCSwAAAAwe8CSIucJKAAAAAPr+nB6AJBifoPr8FBiehMAdBMAcJIjQSDSI0ck0g52A+DyQIAAEGJyEHR6EnB4AJKjRQASDnC"
            . "dxXpCwMAAA8fAEiDwARIOcIPhpUCAACAeAMAdO1IK4QkoAAAADHSSMH4AvfxSIucJIAAAABIi7wkiAAAAEGJ0A+3wEQrjCSwAAAA"
            . "ifVBweAQRA+vzg+30inNQQnARIlDCEGJwEiLnCSgAAAARA+vwUqNPI9JAdBGizSDSDm8JIgAAAAPg7gAAAAPr8aJ80WJ3EyLlCSI"
            . "AAAASIlcJChFMclB99xIAdBIidpIweACSIlEJAiJyEgpwkyNPIUAAAAASI0ElQAAAABIiUQkEI1B/0jB4AJIiUQkGEEPtsZmiUQk"
            . "JESJ8A+2xIlEJCBEifDB6BAPtsBmiUQkJuszZg8fRAAASItEJAhMAdBmRYXbdUpEOzAPhIkAAABBg8EBMcBJg8IEQTnxRA9DyEk5"
            . "+nMSRDnNc85MA1QkGEUxyUk5+nLuMcBIg8Q4W15fXUFcQV1BXkFfw2YPH0QAAA+2CA+3VCQkKcpmQTnTcwZmRDnicqkPtkgBD7dU"
            . "JCApymZBOdNzBmZEOeJykg+2UAIPt0QkJinQZkE5w3MKZkQ54A+Cd////4uEJLAAAACFwHRNSIuEJKAAAABMidIx20qNDDhIOchz"
            . "N2ZFhdt1cZCAeAMAdAxEiwJEOQAPhT3///9Ig8AESIPCBEg5wXfhSANUJBCDwwE7nCSwAAAAdcBMidBIK4QkiAAAAEjB+AJImUj3"
            . "fCQoZg9uwmYPOiLAAUiLhCSAAAAAZg/WALgBAAAA6RP///9mLg8fhAAAAAAAgHgDAHRaRA+2AEQPtipFKehmRTnDcwpmRTnED4e+"
            . "/v//RA+2QAFED7ZqAUUp6GZFOcNzCmZFOcQPh6H+//9ED7ZAAkQPtmoCRSnoZkU5w3MPZkU5xA+HhP7//w8fRAAASIPABEiDwgRI"
            . "OcF3k+k9////TAHASDnDD4dB/f//So0UlQAAAABBicpIi5wkoAAAAI1H/ynNQSn6SPfaSAHoScHiAkiNBINJ99pJicBJAdByD+sp"
            . "Dx9AAEiD6ARJOcBzHIB4AwB08ekX/f//icfB7xCJ+ukb/f//SInQ65hMAdDryA==")
      ...
      ImageSearchAll(image, variation := 0) {
         ...
         code := this.Base64Code((A_PtrSize == 4)
            ...
            : "QVdBVkFVQVRVV1ZTSIPsSEQPt5wk2AAAAIuEJNAAAABIiYwkkAAAAESJy4mUJJgAAABMiYQkoAAAAIXAD4XiAwAAi4QkyAAAAESL"
            . "lCTAAAAAi7QkwAAAAA+vtCTIAAAAwegCD6+EJMAAAACLlCTAAAAAQcHqAkiLvCS4AAAARYnQifFMAcBIAcpIjQSHTI0Ml0w5yA+D"
            . "NAMAAIuMJMAAAADR6UjB4QJIjRQISDnCdxXplwMAAA8fAEiDwARIOcIPhv0CAACAeAMAdO1IK4QkuAAAADHSSMH4Ave0JMAAAABm"
            . "iVQkKA+3yA+3VCQoSIu0JLgAAACJ34nID6+EJMAAAACJTCQ0K7wkwAAAAEgB0ESLJIaLhCSwAAAAK4QkyAAAAEiLtCSgAAAAD6/D"
            . "SI00hkg5tCSgAAAAD4P0AgAAiciJ2USJ3cdEJCQAAAAAD6/DSIlMJDhFMcD33UyLlCSgAAAASAHQSInKSMHgAkiJRCQIi4QkwAAA"
            . "AEgpwkyNLIUAAAAASI0ElQAAAABIiUQkEIuEJMAAAACD6AFIweACSIlEJBhBD7bEZolEJDBEieAPtsSJRCQsRIngwegQD7bAZolE"
            . "JDLrN2YuDx+EAAAAAABIi0QkCEwB0GZFhdt1ckQ7IA+EsgAAAEmDwgRBg8ABMcBBOdhED0PATDnWdhJBOfh2zkwDVCQYRTHATDnW"
            . "d+6LRCQkSIu8JJAAAAABwEiNBIdIiYQkkAAAAEiJw4tEJCjB4BALRCQ0iQOLRCQkSIPESFteX11BXEFdQV5BX8NmkA+2CA+3VCQw"
            . "KcpmQTnTcwVmOepygg+2SAEPt1QkLCnKZkE503MJZjnqD4Jo////D7ZQAg+3RCQyKdBmQTnDcwlmOegPgk7///+LjCTIAAAASIuE"
            . "JLgAAABMidJFMfaFyXRISo0MKEg5wXY/ZkWF2w+FiwAAAA8fAIB4AwB0DESLOkQ5OA+FDf///0iDwARIg8IESDnBd+FIA1QkEEGD"
            . "xgFEObQkyAAAAHW4i0wkJDmMJJgAAAB2MEyJ0EgrhCSgAAAASMH4AkiZSPd8JDhmD27CZg86IsABjQQJSIuMJJAAAABmD9YEgYNE"
            . "JCQBTQHqRAOEJMAAAADpo/7//w8fQACAeAMAdFpED7YIRA+2OkUp+WZFOctzCmZEOc0Ph3b+//9ED7ZIAUQPtnoBRSn5ZkU5y3MK"
            . "ZkQ5zQ+HWf7//0QPtkgCRA+2egJFKflmRTnLcw9mRDnND4c8/v//Dx9EAABIg8AESIPCBEg5wXeT6SX///9IAchJOcEPh9n8//9K"
            . "jRSFAAAAAESLhCTAAAAAK7QkwAAAAEGNQv9IAfBIi7QkuAAAAEj32kUp0EnB4AJIjQSGSffYSInBSAHRcgzrOJBIg+gESDnBcy6A"
            . "eAMAdPHpp/z//4nHwe8QiXwkKOmz/P//x0QkJAAAAABIi5wkkAAAAOnl/f//TAHA67lIidDpcf///w==")
